...
(* OASIS_START *)
(* DO NOT EDIT (digest: c7ddf0db92195e676f9efb18692b25c3) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_oliblinear", []))];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/travisbrady/oliblinear";
                  ...
                  },
                   {
                      ...
                      bs_cclib =
                        [
                           ...
                           (OASISExpr.ETest ("system", "linux"),
                             ["-Xlinker"; "--no-as-needed"; "-llinear"]);
                           (OASISExpr.ENot
                              (OASISExpr.ETest ("system", "linux")),
                             ["-llinear"])
                        ];
                      bs_dlllib =
                        [(OASISExpr.EBool true, ["-llinear_stubs"])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])]
                   },
                   {
                      lib_modules = ["Liblinear"; "Oliblinear"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "oliblinear";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "test_oliblinear";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_oliblinear.ml"});
               Test
                 ({
                     cs_name = "test_oliblinear";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "\018U\151¹ÝÜ\027\152DÐÛl\019w/\000";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
